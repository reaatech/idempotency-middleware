...
describe('IdempotencyError', () => {
  it('should create error with code and message', () => {
    const error = new IdempotencyError(IdempotencyErrorCode.KEY_REQUIRED, 'Key is required');
  ...
  it('should include cause and context', () => {
    ...
    const error = new IdempotencyError(IdempotencyErrorCode.STORAGE_ERROR, 'Storage failed', {
      cause,
      context: { key: 'test' },
    });
